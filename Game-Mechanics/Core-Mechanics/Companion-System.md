...
**For the guiding design principles behind what a post-romance mini-questline's content should actually contain** — including two rules not restated here, "chosen vulnerability vs. stress vulnerability" and "relational conflict rather than external conflict" — see `Worldspace/Design_Principles.md`, Section III. This section covers only the reward mechanic.
