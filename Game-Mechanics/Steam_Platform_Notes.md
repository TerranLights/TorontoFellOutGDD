...
Reference document for Steam platform policies relevant to Toronto Fell Out's design and development. Covers content ratings, sexual content rules, and publishing considerations.
...
Steam has a self-reported content tagging system. Relevant tags for Toronto Fell Out will likely include:
...
## Recommendation for Toronto Fell Out
...
Given Toronto Fell Out's other content (violence, mature themes, adult language), the game will almost certainly be Mature/18+ regardless of the romance scenes. The M-rated sex scene approach is well within reach under standard submission without any special approval process.
...
Toronto Fell Out's approach (one sex scene per completed romance, contextualized within the romance arc) fits comfortably within the space both of these games occupy.
