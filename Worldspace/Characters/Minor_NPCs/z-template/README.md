...
**Enneagram / Personality Framework:** *(populated during character design — Enneagram is confirmed, binding Toronto Fell Out infrastructure; this is not an optional field)*
...
**MAPLE-BUD Stat Profile (rough baseline):**
- Might:
- Agility:
- Perception:
- Luck:
...
- Behavior under stress or in different districts:
...
- “Not my problem” / hidden path potential:
...
## Relationships & Hooks
- Key connections:
- Dialogue / quest hooks (skills, reputation, etc.):
